...
urlpatterns = [
    ...
    path('direktor/edit_course/<str:id>', user_login.EDITCOURSE, name='edit_course'),
    path('direktor/update_course', user_login.UPDATECOURSE, name='update_course'),
    path('direktor/delete_course/<str:id>', user_login.DELETECOURSE, name='delete_course'),

    path('direktor/session/add', user_login.ADDSESSION, name='add_session'),
    path('direktor/session/view', user_login.VIEWSESSION, name='view_session'),
    path('direktor/session/edit/<str:id>', user_login.EDITSESSION, name='edit_session'),
    path('direktor/session/update', user_login.UPDATESESSION, name='update_session'),
    path('direktor/session/delete/<str:id>', user_login.DELETESESSION, name='delete_session'),
